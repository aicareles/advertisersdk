...
import com.heaton.advertisersdk.exception.AdvertiserException;
import com.heaton.advertisersdk.proxy.RequestImpl;
import com.heaton.advertisersdk.proxy.RequestLisenter;
import com.heaton.advertisersdk.proxy.RequestProxy;
import com.heaton.advertisersdk.request.AdvertiserRequest;
import com.heaton.advertisersdk.request.Rproxy;
import com.heaton.advertisersdk.request.ScanRequest;
...
public final class AdvertiserClient<T extends AdvertiserDevice>{
     ...
     */
    public void search(AdvertiserDiscoverCallback callback){
     ...
     */
    public void connect(AdvertiserDevice device, AdvertiserConnectCallback callback){
